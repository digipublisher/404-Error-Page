...
Stack: HTML & CSS \
Level: Beginner\
Demo : [Demo](https://404-page-using-html-css.netlify.app/)\
Tutorial : [Tutorialurl](https://frontendsprojects.teachable.com/courses/frontend-projects-tutorial/lectures/39552995)

---

### Project Brief
#### In this tutorial we’re going to learn how to create 404 Page using only html and css
